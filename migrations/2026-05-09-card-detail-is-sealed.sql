-- migrations/2026-05-09-card-detail-is-sealed.sql
-- Expose cards.is_sealed via the card-detail RPC so the client can render
-- a single-tile (or populated-only) price display for sealed products
-- instead of the full grade ladder.
