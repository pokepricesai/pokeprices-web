...
async function handle(req: Request) {
  ...
  // ingest.status has already been narrowed to 'ok' | 'noop_no_new_dates'
  // by the earlier failure early-return; the only remaining question is
  // whether the refresh passed hard reconciliation.
