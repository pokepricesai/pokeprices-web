...
const featureBlocks: FeatureBlock[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Watchlist',                 href: '/dashboard/watchlist', description: 'Cards you do not own yet but want to follow.' },
      { label: 'Set Completion tracker',    href: '/dashboard/sets',   description: 'Tick off owned cards, see missing-by-value.' },
      { label: 'Smart Alerts',              href: '/dashboard/alerts', description: 'Email when a card breaks a price you care about.' },
