    ...
    <>
      <section style={{
        ...
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <img src="/logo.png" alt="PokePrices — Pokemon Card Prices" style={{
                ...
                >
                  {card.image_url ? (
                    <img src={card.image_url} alt={card.card_name} style={{
                      width: 90, height: 126, objectFit: 'contain', marginBottom: 8, borderRadius: 6,
                    }} loading="lazy" />
                  ) : (
                    <div style={{
                  ...
                  <div style={{ fontSize: 13, fontWeight: 800, marginBottom: 1, fontFamily: "'Figtree', sans-serif" }}>
                    {formatPrice(card.current_raw)}
                  </div>
                  <div style={{ fontSize: 12, fontWeight: 700, color: pct.color, fontFamily: "'Figtree', sans-serif" }}>
                    {pct.text}
                  </div>
                </Link>
              )
      ...
      <section style={{ padding: '20px 24px 40px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{
          ...
          overflow: 'hidden', boxShadow: '0 2px 15px rgba(37,99,168,0.06)',
        }}>
          <div style={{
            background: 'linear-gradient(135deg, #1a5fad, #2874c8)', padding: '20px 24px',
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            flexWrap: 'wrap', gap: 14,
          }}>
            <div>
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, letterSpacing: 2, margin: '0 0 2px', textTransform: 'uppercase', fontWeight: 700, fontFamily: "'Figtree', sans-serif" }}>
                Next Release
              </p>
      ...
      <section style={{ padding: '16px 24px 44px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--text-muted)', textAlign: 'center', fontSize: 14, margin: '0 0 28px', fontFamily: "'Figtree', sans-serif" }}>
      ...
      <section style={{ padding: '44px 24px', maxWidth: 680, margin: '0 auto' }}>
        <h2 style={{ fontSize: 24, textAlign: 'center', margin: '0 0 24px', fontFamily: "'Playfair Display', serif" }}>
        ...
        {faqs.map((faq, i) => (
          <details key={i} style={{
            ...
            <div style={{ padding: '0 18px 14px', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6, fontFamily: "'Figtree', sans-serif" }}>
              {faq.a}
            </div>
          </details>
        ))}
